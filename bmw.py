...
def autotrader():
    url = 'https://www.autotrader.com/rest/lsc/alpha/base?allListingType=all-cars&makeCode=BMW&city=Hallandale&state=FL&zip=33009&location=%5Bobject%20Object%5D&mileage=150000&transmissionCode=MAN&searchRadius=50&endYear=1997&marketExtension=include&newSearch=false&showAccelerateBanner=false&sortBy=datelistedDESC&numRecords=25&dma=%5Bobject%20Object%5D&channel=ATC&relevanceConfig=relevance-v2&stats=year%2Cderivedprice'
...
def craiglist():
    url = 'https://miami.craigslist.org/search/hallandale-fl/cta?lat=25.98100&lon=-80.14900&search_distance=15&min_price=&max_price=&auto_make_model=bmw&max_auto_year=1997&max_auto_miles=150000&auto_transmission=1'
