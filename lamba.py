...
def autotrader():
    url = 'https://www.autotrader.com/rest/lsc/alpha/base?allListingType=all-cars&makeCode=LAM&city=Hallandale&state=FL&zip=33009&location=%5Bobject%20Object%5D&searchRadius=50&marketExtension=include&sellerType=p&newSearch=true&showAccelerateBanner=false&sortBy=datelistedDESC&numRecords=25&requestId=p&dma=%5Bobject%20Object%5D&channel=ATC&relevanceConfig=relevance-v2&stats=year%2Cderivedprice'
...
def craiglist():
    url = 'https://miami.craigslist.org/search/hallandale-fl/cta?lat=25.98100&lon=-80.14900&search_distance=15&min_price=&max_price=&auto_make_model=lamborghini'
...
def carscom():
    url = 'https://www.cars.com/shopping/results/?dealer_id=&keyword=&list_price_max=&list_price_min=&makes[]=lamborghini&maximum_distance=30&mileage_max=&page_size=20&seller_type[]=private_seller&sort=listed_at_desc&stock_type=all&year_max=&year_min=&zip=33009'
